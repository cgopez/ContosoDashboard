        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileType = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_Projects_AssociatedProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentActivities_Users_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DocumentScanId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    ScannedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Scanner = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ScanStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    Details = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentScans", x => x.DocumentScanId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithTeamId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentShares_Users_SharedById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(8900), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(8910), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(8910), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(8910), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 5, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9320), true, new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9320), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 3, 22, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9150), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 3, 22, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9130), 1, new DateTime(2026, 6, 20, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9140), new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9150) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 22, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9290), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 3, 22, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9290), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 3, 22, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9190), "Create entity relationship diagram and database design", new DateTime(2026, 4, 1, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9190), 2, 1, 2, "Design database schema", new DateTime(2026, 4, 1, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9190) },
                    { 2, 4, 2, new DateTime(2026, 3, 27, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9250), "Set up Microsoft Entra ID authentication", new DateTime(2026, 4, 26, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9250), 3, 1, 1, "Implement authentication", new DateTime(2026, 4, 21, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9250) },
                    { 3, 4, 2, new DateTime(2026, 4, 1, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9260), "Design user interface mockups for all main pages", new DateTime(2026, 5, 1, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9260), 1, 1, 0, "Create UI mockups", new DateTime(2026, 4, 1, 7, 29, 11, 745, DateTimeKind.Utc).AddTicks(9260) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentActivities_ActorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_AssociatedProjectId",
                table: "Documents",
